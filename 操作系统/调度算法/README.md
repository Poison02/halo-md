...
这里是虚拟内存的管理整个流程，你可以从下面这张图看到：

![虚拟内存的流程](assets/虚拟内存管理流程.png)
...
![最近最久未使用的置换算法](assets/LRU置换算法.png)
