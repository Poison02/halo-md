...
![Buffer Poo](./MySQL日志篇.assets/缓冲池.drawio.png)
...
![img](./MySQL日志篇.assets/bufferpool内容.drawio.png)
...
![事务恢复](./MySQL日志篇.assets/redologbuf.webp)
...
![img](./MySQL日志篇.assets/innodb_flush_log_at_trx_commit.drawio.png)
...
![img](./MySQL日志篇.assets/innodb_flush_log_at_trx_commit2.drawio.png)
...
![重做日志文件组](./MySQL日志篇.assets/重做日志文件组.drawio.png)
...
![重做日志文件组写入过程](./MySQL日志篇.assets/重做日志文件组写入过程.drawio.png)
...
![img](./MySQL日志篇.assets/checkpoint.png)
...
![MySQL 主从复制过程](./MySQL日志篇.assets/主从复制过程.drawio.png)
...
![MySQL 主从架构](./MySQL日志篇.assets/主从架构.drawio.png)
...
![binlog cach](./MySQL日志篇.assets/binlogcache.drawio.png)
...
![两阶段提交](./MySQL日志篇.assets/两阶段提交.drawio.png)
...
![时刻 A 与时刻 B](./MySQL日志篇.assets/两阶段提交崩溃点.drawio.png)
...
![每个阶段都有一个队列](./MySQL日志篇.assets/commit_4.png)
