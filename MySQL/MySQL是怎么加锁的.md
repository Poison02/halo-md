...
![img](./MySQL是怎么加锁的.assets/x锁和s锁-1692606937695-1.png)
...
![img](./MySQL是怎么加锁的.assets/记录锁.drawio-1692606937695-3.png)
...
![img](./MySQL是怎么加锁的.assets/gap锁.drawio-1692606937696-5.png)
...
![img](./MySQL是怎么加锁的.assets/临键锁.drawio-1692606937696-7.png)
...
![img](./MySQL是怎么加锁的.assets/user-1692606937696-9.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引记录锁.drawio-1692606937696-11.png)

接下来，如果有其他事务，对 id 为 1 的记录进行更新或者删除操作的话，这些操作都会被阻塞，因为更新或者删除操作也会对记录加 X 型的记录锁，而 X 锁和 X 锁之间是互斥关系。

比如，下面这个例子：

![img](./MySQL是怎么加锁的.assets/唯一索引等值查询（存在）.drawio-1692606937696-13.png)
...
![img](./MySQL是怎么加锁的.assets/事务a加锁分析-1692606937696-15.png)
...
![img](./MySQL是怎么加锁的.assets/事务a分析1-1692606937696-17.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引间隙锁.drawio-1692606937696-19.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引等值查询（不存在）.drawio-1692606937696-21.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询大于15.drawio-1692606937696-23.png)
...
![img](./MySQL是怎么加锁的.assets/范围查询大于-1692606937696-25.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询大于等于15.drawio-1692606937696-27.png)
...
![img](./MySQL是怎么加锁的.assets/范围查询大于等于-1692606937696-29.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询小于等于6.drawio-1692606937696-31.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询小于6-1692606937696-33.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询小于等于5.drawio-1692606937696-35.png)
...
![img](./MySQL是怎么加锁的.assets/范围查询小于等于-1692606937696-37.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询小于5.drawio-1692606937696-39.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引范围查询小于-1692606937696-41.png)
...
![img](./MySQL是怎么加锁的.assets/非唯一索引等值查询age=25.drawio-1692606937696-43.png)

我们也可以通过 `select * from performance_schema.data_locks\G;` 这条语句来看看事务 A 加了什么锁。

输出结果如下，我这里只截取了行级锁的内容。

![img](./MySQL是怎么加锁的.assets/非唯一索引等值查询age=25-1692606937696-45.png)
...
![img](./MySQL是怎么加锁的.assets/非唯一索引等值查询age=25_1-1692606937696-47.png)
...
![img](./MySQL是怎么加锁的.assets/非唯一索引等值查询存在.drawio-1692606937696-49.png)
...
![img](./MySQL是怎么加锁的.assets/非唯一索引等值查询（存在）-1692606937696-51.png)
...
![img](./MySQL是怎么加锁的.assets/非唯一索引范围查询age大于等于22.drawio-1692606937696-53.png)
...
![img](./MySQL是怎么加锁的.assets/唯一索引加锁流程-1692606937696-55.jpeg)

非唯一索引加锁的流程图：

![img](./MySQL是怎么加锁的.assets/非唯一索引加锁流程-1692606937696-57.jpeg)