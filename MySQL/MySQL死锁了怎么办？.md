...
![图片](./MySQL死锁了怎么办？.assets/54fc00f9f87a60ab7b5ba92d824a892d.png)

假设这时有两事务，一个事务要插入订单 1007 ，另外一个事务要插入订单 1008，因为需要对订单做幂等性校验，所以两个事务先要查询该订单是否存在，不存在才插入记录，过程如下：

![img](./MySQL死锁了怎么办？.assets/90c1e01d0345de639e3426cea0390e80.png)
...
![img](./MySQL死锁了怎么办？.assets/8ae18f10f1a89aac5e93f0e9794e469e.png)
...
![图片](./MySQL死锁了怎么办？.assets/8d1dfbab758fe7e4c58563fca9ccb6d4.png)
...
![img](./MySQL死锁了怎么办？.assets/90c1e01d0345de639e3426cea0390e80-20230309222252447.png)
...
![img](./MySQL死锁了怎么办？.assets/1cf8614eba3b45b9874dc6204b4d0cd1.png)
...
![img](./MySQL死锁了怎么办？.assets/fb6709207ac445ddbc175e3cdf993ff2.png)
...
![img](./MySQL死锁了怎么办？.assets/5条数据.png)
...
![img](./MySQL死锁了怎么办？.assets/事务A间隙锁.png)
...
![img](./MySQL死锁了怎么办？.assets/事务b插入意向锁.png)
...
![img](./MySQL死锁了怎么办？.assets/插入失败.png)
...
![img](./MySQL死锁了怎么办？.assets/s类型锁.png)
...
![img](./MySQL死锁了怎么办？.assets/唯一索引加锁.drawio.png)
...
![img](./MySQL死锁了怎么办？.assets/事务a显示锁.png)
...
![img](./MySQL死锁了怎么办？.assets/事务b等待.png)
...
![img](./MySQL死锁了怎么办？.assets/8ae18f10f1a89aac5e93f0e9794e469e-20230310003449585.png)
...
![图片](./MySQL死锁了怎么办？.assets/c296c1889f0101d335699311b4ef20a8.png)

- **开启主动死锁检测**。主动死锁检测在发现死锁后，主动回滚死锁链条中的某一个事务，让其他事务得以继续执行。将参数 `innodb_deadlock_detect` 设置为 on，表示开启这个逻辑，默认就开启。

  当检测到死锁后，就会出现下面这个提示：

![图片](./MySQL死锁了怎么办？.assets/f380ef357d065498d8d54ad07f145e09.png)
