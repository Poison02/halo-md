...
![图片](./MySQL事务总结.assets/10b513008ea35ee880c592a88adcb12f.png)
...
![图片](./MySQL事务总结.assets/f5b4f8f0c0adcf044b34c1f300a95abf.png)
...
![图片](./MySQL事务总结.assets/d19a1019dc35dfe8cfe7fbff8cd97e31.png)
...
![图片](./MySQL事务总结.assets/d37bfa1678eb71ae7e33dc8f211d1ec1.png)
...
![图片](./MySQL事务总结.assets/cce766a69dea725cd8f19b90db2d0430.png)

针对不同的隔离级别，并发事务时可能发生的现象也会不同。

![图片](./MySQL事务总结.assets/4e98ea2e60923b969790898565b4d643.png)
...
![图片](./MySQL事务总结.assets/d5de450e901ed926d0b5278c8b65b9fe.png)
...
![img](./MySQL事务总结.assets/readview结构.drawio.png)
...
![图片](./MySQL事务总结.assets/f595d13450878acd04affa82731f76c5.png)
...
![img](./MySQL事务总结.assets/ReadView.drawio.png)
...
![img](./MySQL事务总结.assets/事务ab的视图-new.png)
...
![img](./MySQL事务总结.assets/事务ab的视图2.png)
...
![img](./MySQL事务总结.assets/读提交事务.png)
...
![img](./MySQL事务总结.assets/读提交事务2.drawio.png)
...
![img](./MySQL事务总结.assets/7f9df142b3594daeaaca495abb7133f5.png)

然后在可重复读隔离级别下，有两个事务的执行顺序如下：

![在这里插入图片描述](./MySQL事务总结.assets/e576e047dccc47d5a59636ea342750b8.png)
...
![img](./MySQL事务总结.assets/1f872ff92b644b5f81cee2dd9188b199.png)
...
![img](./MySQL事务总结.assets/gap锁.drawio.png)

举个具体例子，场景如下：

![img](./MySQL事务总结.assets/3af285a8e70f4d4198318057eb955520.png)
...
![img](./MySQL事务总结.assets/7f9df142b3594daeaaca495abb7133f5-20230309222119359.png)
...
![img](./MySQL事务总结.assets/幻读发生.drawio.png)
