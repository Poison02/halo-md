...
![Message queue](assets/message-queue-small.png)

<center>Message queue</center>

参与消息传递的双方称为 **生产者** 和 **消费者** ，生产者负责发送消息，消费者负责处理消息。

![发布/订阅（Pub/Sub）模型](assets/message-queue-pub-sub-model-63a717b4-169347544146227.png)
...
![通过异步处理提高系统性能](assets/Asynchronous-message-queue.png)
...
![队列模型](assets/message-queue-queue-model-3aa809bf-169347541306924.png)
...
![发布/订阅（Pub/Sub）模型](assets/message-queue-pub-sub-model-63a717b4-169347531434721.png)
...
![img](assets/kafka3.3.1-kraft- production-ready.png)
