...
![img](./AOP持久化是怎么实现的.assets/6f0ab40396b7fc2c15e6f4487d3a0ad7.png)

这种保存写操作命令到日志的持久化方式，就是 Redis 里的 **AOF(\*Append Only File\*)** 持久化功能，**注意只会记录写操作命令，读操作命令是不会被记录的**，因为没意义。

在 Redis 中 AOF 持久化功能默认是不开启的，需要我们修改 `redis.conf` 配置文件中的以下参数：

![img](./AOP持久化是怎么实现的.assets/0e2d081af084c41802c7b5de8aa41bd4.png)
...
![img](./AOP持久化是怎么实现的.assets/337021a153944fd0f964ca834e34d0f2.png)
...
![img](./AOP持久化是怎么实现的.assets/28afd536c57a46447ddab0a2062abe84.png)
...
![img](./AOP持久化是怎么实现的.assets/4eeef4dd1bedd2ffe0b84d4eaa0dbdea.png)
...
![img](./AOP持久化是怎么实现的.assets/98987d9417b2bab43087f45fc959d32a.png)
...
![img](./AOP持久化是怎么实现的.assets/f64829ffc2e9e006b090f9aae51035ee.png)
...
![img](./AOP持久化是怎么实现的.assets/723d6c580c05400b3841bc69566dd61b.png)
...
![img](./AOP持久化是怎么实现的.assets/5a1f2a90b5f3821c19bea3b7a5f27fa1.png)
...
![img](./AOP持久化是怎么实现的.assets/d4cfac545377b54dd035c775603b4936.png)
...
![在这里插入图片描述](./AOP持久化是怎么实现的.assets/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM0ODI3Njc0,size_16,color_FFFFFF,t_70-20230309231944807.png)
