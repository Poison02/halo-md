...
![图片](./RDB快照是怎么实现的？.assets/c34a9d1f58d602ff1fe8601f7270baa7.png)

只有在发生修改内存数据的情况时，物理内存才会被复制一份。

![图片](./RDB快照是怎么实现的？.assets/ebd620db8a1af66fbeb8f4d4ef6adc68.png)
...
![图片](./RDB快照是怎么实现的？.assets/f67379b60d151262753fec3b817b8617.jpeg)
