...
![img](assets/38ef122122de4375abcd27c3de8f60b4.png)
...
![Spring4.x主要模块](assets/jvme0c60b4606711fc4a0b6faf03230247a.png)

<div align="center">Spring4.x主要模块</div>

**Spring5.x 版本**：

![Spring5.x主要模块](assets/20200831175708.png)
...
![Spring主要模块](assets/jvme0c60b4606711fc4a0b6faf03230247a-16930428513471.png)
...
![IoC 图解](assets/frc-365faceb5697f04f31399937c059c162.png)
...
![img](assets/062b422bd7ac4d53afd28fb74b2bc94d.png)
...
![Spring Bean 生命周期](assets/24bc2bad3ce28144d60d9e0a2edf6c7f.jpg)

<div align="center">Spring Bean 生命周期</div>

与之比较类似的中文版本:

![Spring Bean 生命周期](assets/b5d264565657a5395c2781081a7483e1.jpg)
...
![SpringAOPProcess](assets/230ae587a322d6e4d09510161987d346.jpeg)
...
![img](assets/159b3d3e70dd45e6afa81bf06d09264e.png)
...
![声明式事务的几种失效的情况](assets/spring-381e4ec9-a235-4cfa-9b4d-518095a7502a.png)
...
![Spring默认支持的异常回滚](assets/spring-04053b02-3264-4d7f-b868-560a0333f08d.png)
...
避免这种只需要使用 `AopContext` 这个代理类去生成当前类的代理对象调用即可解决事务失效。
...
![img](assets/image-20220728201854641.png)
...
![img](assets/image-20220728183540954.png)
