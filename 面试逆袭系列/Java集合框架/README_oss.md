...
![Java集合主要关系](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-1.png)
...
![ArrayList和LinkedList的数据结构](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-2.png)
...
![ArrayList和LinkedList中间插入](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-3.png)

<div align="center">ArrayList和LinkedList中间插入</div>

![ArrayList和LinkedList中间删除](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-4.png)
...
![ArrayList扩容](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-5.png)
...
![ArrayList自定义序列化](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-6.png)

<div align="center">ArrayList自定义序列化</div>
...
![CopyOnWriteArrayList原理](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-7.png)

<div align="center">CopyOnWriteArrayList原理</div>
...
![jdk1.8 hashmap数据结构示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-8.png)
...
![红黑树](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-9.png)
...
![左旋](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-10.png)

<div align="center">左旋</div>

![右旋](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-11.png)

<div align="center">右旋</div>

- 染⾊：

![染色](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-12.png)
...
![HashMap插入数据流程图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-13.jpg)
...
![HashMap查找流程图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-14.png)

<div align="center">HashMap查找流程图</div>
...
![哈希&运算](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-15.png)

<div align="center">哈希&运算</div>
...
![扰动函数示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-16.jpg)
...
![put中的扩容](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-17.png)
...
![容量计算](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-18.png)
...
![散列函数构造](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-19.png)
...
![开放定址法](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-20.png)
...
![源码注释](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-21.png)
...
![put时，扩容](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-22.png)
...
![threshold计算](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-23.png)
...
![关于默认负载因子的注释](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-24.png)

<div align="center">关于默认负载因子的注释</div>
...
![扩容之后的索引计算](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-25.png)

<div align="center">扩容之后的索引计算</div>

元素在重新计算hash之后，因为n变为2倍，那么n-1的mask范围在高位多1bit(红色)，因此新的index就会发生这样的变化：

![扩容位置变化](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-26.png)

<div align="center">扩容位置变化</div>

所以在扩容时，只需要看原来的hash值新增的那一位是0还是1就行了，是0的话索引没变，是1的化变成`原索引+oldCap`，看看如16扩容为32的示意图：

![扩容节点迁移示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-27.png)

<div align="center">扩容节点迁移示意图</div>

扩容节点迁移主要逻辑：

![扩容主要逻辑](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-28.png)

<div align="center">扩容主要逻辑</div>
...
![自定义HashMap整体结构](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-29.png)

<div align="center">自定义HashMap整体结构</div>

完整代码：

![完整代码](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-30.png)

<div align="center">完整代码</div>
...
![1.7ConcurrentHashMap示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-31.png)
...
![jdk1.7 put流程](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/20211128230624.jpg)
...
![ConcurrentHashmap jdk1.8put流程](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-32.jpg)
...
![Entry节点](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-33.png)

<div align="center">Entry节点</div>

可以实现按插入的顺序或访问顺序排序。

![LinkedHashMap实现原理](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-34.png)
...
![TreeMap](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-35.png)
...
![HashSet套娃](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/collection-36.png)

<div align="center">HashSet套娃</div>
