...
![下辈子还学Java](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-1.png)

<div align="center">下辈子还学Java</div>
...
![Java语言特点](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-2.png)

<div align="center">Java语言特点</div>
...
![JDK、JRE、JVM关系](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-3.png)

<div align="center">JDK、JRE、JVM关系</div>
...
![Java程序执行过程](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-4.png)

<div align="center">Java程序执行过程</div>
...
![编译与解释](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-5.png)

<div align="center">编译与解释</div>
...
![Java数据类型](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-6.png)

<div align="center">Java数据类型</div>
...
![Java自动类型转换方向](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-7.png)

<div align="center">Java自动类型转换方向</div>
...
![装箱和拆箱](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-8.png)

<div align="center">装箱和拆箱</div>
...
![break 、continue 、return](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-9.png)

<div align="center">break 、continue 、return</div>
...
![面向对象和面向过程的区别](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-10.png)

<div align="center">面向对象和面向过程的区别</div>

## 16.面向对象有哪些特性

![面向对象三大特征](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-11.png)

<div align="center">面向对象三大特征</div>
...
![访问修饰符和可见性](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-12.png)

<div align="center">访问修饰符和可见性</div>
...
![final修饰变量](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-13.png)

<div align="center">final修饰变量</div>
...
![Java引用数据值传递示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-14.png)

<div align="center">Java引用数据值传递示意图</div>
...
![浅拷贝和深拷贝示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-15.png)

<div align="center">浅拷贝和深拷贝示意图</div>
...
![Java创建对象的四种方式](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-16.png)

<div align="center">Java创建对象的四种方式</div>
...
![堆与常量池中的String](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-17.png)

<div align="center">堆与常量池中的String</div>
...
![jdk1.8之前的字符串拼接](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-18.png)

<div align="center">jdk1.8之前的字符串拼接</div>
...
![Integer.valueOf](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-19.png)

<div align="center">Integer.valueOf</div>
...
![parseInt示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-20.png)

<div align="center">parseInt示意图</div>
...
![Object类的方法](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-21.png)

<div align="center">Object类的方法</div>
...
![Java异常体系](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-22.png)Java异常体系
...
![异常处理](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-23.png)

<div align="center">异常处理</div>
...
![IO-操作方式分类-图片来源参考[2]](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-24.jpeg)

<div align="center">IO-操作方式分类-图片来源参考[2]</div>
...
![Java IO流用到装饰器模式](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-25.png)

<div align="center">Java IO流用到装饰器模式</div>
...
![BIO、NIO、AIO](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-26.png)

<div align="center">BIO、NIO、AIO</div>
...
![BIO、NIO、AIO](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-27.png)
...
![NIO线程](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-28.png)

<div align="center">NIO线程</div>

NIO 的数据是面向**缓冲区 Buffer**的，必须从 Buffer 中读取或写入。

所以完整的 NIO 示意图：

![NIO完整示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-29.png)

<div align="center">NIO完整示意图</div>
...
![序列化和反序列化](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-30.png)

<div align="center">序列化和反序列化</div>
...
![Java常见序列化方式](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-31.png)

<div align="center">Java常见序列化方式</div>
...
![泛型类、泛型接口、泛型方法](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-32.png)

<div align="center">泛型类、泛型接口、泛型方法</div>
...
![Java注解和帽子](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-33.png)

<div align="center">Java注解和帽子</div>
...
![Override注解](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-34.png)Override注解
...
![Autowired注解](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-35.png)Autowired注解
...
![Java反射相关类](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-36.png)

<div align="center">Java反射相关类</div>
...
![JDK1.8主要新特性](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-37.png)

<div align="center">JDK1.8主要新特性</div>
...
![Java Stream流](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/javase-38.png)

<div align="center">Java Stream流</div>