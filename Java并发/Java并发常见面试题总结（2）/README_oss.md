...
![CPU 缓存模型示意图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/cpu-cache.png)
...
![缓存一致性协议](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/cpu-cache-protocol.png)
...
![JMM(Java 内存模型)](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/jmm.png)
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/image-20220731155332375.png)
...
![happens-before 与 JMM 的关系](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/image-20220731084604667.png)
...
![JMM(Java 内存模型)强制在主存中进行读取](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/jmm2.png)
...
![JUC原子类概览](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/JUC原子类概览.png)
...
![synchronized关键字原理](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/synchronized-principle.png)synchronized关键字原理
...
![执行 monitorenter 获取锁](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/synchronized-get-lock-code-block.png)

对象锁的的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。

![执行 monitorexit 释放锁](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/synchronized-release-lock-block.png)
...
![synchronized关键字原理](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/synchronized关键字原理2.png)
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/reentrantlock-class-diagram.png)
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/reentrantreadwritelock-class-diagram.png)
