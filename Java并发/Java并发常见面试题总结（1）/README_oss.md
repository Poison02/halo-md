...
![进程示例图片-Windows](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/进程示例图片-Windows.png)

<div align="center">进程示例图片-Windows</div>
...
![Java 运行时数据区域（JDK1.8 之后）](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/java-runtime-data-areas-jdk1.8.png)

<div align="center">Java 运行时数据区域（JDK1.8 之后)</div>
...
![Java 线程状态变迁图](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/640.png)

<div align="center">Java 线程状态变迁图</div>
...
![RUNNABLE-VS-RUNNING](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/RUNNABLE-VS-RUNNING.png)

<div align="center">RUNNABLE-VS-RUNNING</div>
...
![线程死锁示意图 ](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/2019-4死锁1.png)

<div align="center">线程死锁示意图 </div>
