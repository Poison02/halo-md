...
![ThreadLocal 数据结构](assets/threadlocal-data-structure.png)

<center>ThreadLocal 数据结构</center>

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](assets/thread-local-inner-class.png)
...
![image-20230828102231930](assets/image-20230828102231930.png)
...
![img](assets/executors-inner-threadpool.png)
...
![image-20230828102056949](assets/image-20230828102056949.png)
...
![img](assets/threadpoolexecutor-methods.png)
...
![动态配置线程池参数最终效果](assets/meituan-dynamically-configuring-thread-pool-parameters.png)动态配置线程池参数最终效果
...
![img](assets/image-20210902093026059.png)
...
![img](assets/40cb932a64694262993907ebda6a0bfetplv-k3u1fbpfcp-zoom-1.png)
