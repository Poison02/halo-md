...
![ThreadLocal 数据结构](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/threadlocal-data-structure.png)

<center>ThreadLocal 数据结构</center>

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/thread-local-inner-class.png)

<center>ThreadLocal内部类</center>
...
![image-20230828102231930](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/image-20230828102231930.png)

<center>通过构造方法实现</center>
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/executors-inner-threadpool.png)
...
![image-20230828102056949](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/image-20230828102056949.png)

<center>线程池各个参数的关系</center>
...
![图解线程池实现原理](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/图解线程池实现原理.png)

<center>图解线程池实现原理</center>
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/threadpoolexecutor-methods.png)
...
![动态配置线程池参数最终效果](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/meituan-dynamically-configuring-thread-pool-parameters.png)动态配置线程池参数最终效果
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/completablefuture-class-diagram.jpg)
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/image-20210902093026059.png)
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/AQS.png)
...
![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/40cb932a64694262993907ebda6a0bfetplv-k3u1fbpfcp-zoom-1.png)

AQS(`AbstractQueuedSynchronizer`)的核心原理图（图源[Java 并发之 AQS 详解](https://www.cnblogs.com/waterystone/p/4920797.html)）如下：

![img](https://halo-md.oss-cn-guangzhou.aliyuncs.com/halo/CLH.png)
