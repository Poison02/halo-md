![提纲](assets/6b9bfd38d2684b3f9843ebabf8771212.png)
...
![三方协议和租房协议](assets/4-租房和三方协议.png)
...
![img](assets/8-content-length字段.png)
...
![img](assets/9-connection字段.png)

HTTP 长连接的特点是，只要任意一端没有明确提出断开连接，则保持 TCP 连接状态。

![HTTP 长连接](assets/d2b20d1cc03936332adb2a68512eb167-20230309231005893.png)
...
![img](assets/10-content-type字段.png)
...
![img](assets/11-content-encoding字段.png)
