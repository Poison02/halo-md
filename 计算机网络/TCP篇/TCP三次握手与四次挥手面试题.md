...
![TCP 头格式](TCP三次握手与四次挥手面试题.assets/format,png-20230309230534096.png)
...
![OSI 参考模型与 TCP/IP 的关系](TCP三次握手与四次挥手面试题.assets/format,png-20230309230419839.png)
...
![img](TCP三次握手与四次挥手面试题.assets/format,png-20230309230424714.png)
...
![img](TCP三次握手与四次挥手面试题.assets/format,png-20230309230428466.png)
...
![TCP 四元组](TCP三次握手与四次挥手面试题.assets/format,png-20230309230433082.png)
...
![img](TCP三次握手与四次挥手面试题.assets/format,png-20230309230436594.png)
...
![UDP 头部格式](TCP三次握手与四次挥手面试题.assets/format,png-20230309230439961.png)
...
![img](TCP三次握手与四次挥手面试题.assets/format,png-20230309230445811.png)
...
![img](TCP三次握手与四次挥手面试题.assets/tcp和udp模块.jpeg)
...
![TCP 三次握手](TCP三次握手与四次挥手面试题.assets/TCP三次握手.drawio.png)

- 一开始，客户端和服务端都处于 `CLOSE` 状态。先是服务端主动监听某个端口，处于 `LISTEN` 状态

![第一个报文 —— SYN 报文](TCP三次握手与四次挥手面试题.assets/format,png-20230309230500953.png)

- 客户端会随机初始化序号（`client_isn`），将此序号置于 TCP 首部的「序号」字段中，同时把 `SYN` 标志位置为 `1`，表示 `SYN` 报文。接着把第一个 SYN 报文发送给服务端，表示向服务端发起连接，该报文不包含应用层数据，之后客户端处于 `SYN-SENT` 状态。

![第二个报文 —— SYN + ACK 报文](TCP三次握手与四次挥手面试题.assets/format,png-20230309230504118.png)

- 服务端收到客户端的 `SYN` 报文后，首先服务端也随机初始化自己的序号（`server_isn`），将此序号填入 TCP 首部的「序号」字段中，其次把 TCP 首部的「确认应答号」字段填入 `client_isn + 1`, 接着把 `SYN` 和 `ACK` 标志位置为 `1`。最后把该报文发给客户端，该报文也不包含应用层数据，之后服务端处于 `SYN-RCVD` 状态。

![第三个报文 —— ACK 报文](TCP三次握手与四次挥手面试题.assets/format,png-20230309230508297.png)
...
![TCP 连接状态查看](TCP三次握手与四次挥手面试题.assets/format,png-20230309230520683.png)
...
![三次握手避免历史连接](TCP三次握手与四次挥手面试题.assets/format,png-20230309230525514.png)
...
![两次握手无法阻止历史连接](TCP三次握手与四次挥手面试题.assets/fe898053d2e93abac950b1637645943f.png)
...
![img](TCP三次握手与四次挥手面试题.assets/相同ack.png)
...
![四次握手与三次握手](TCP三次握手与四次挥手面试题.assets/format,png-20230309230639121.png)
...
![两次握手会造成资源浪费](TCP三次握手与四次挥手面试题.assets/format,png-20230309230636571.png)
...
![img](TCP三次握手与四次挥手面试题.assets/isn相同.png)
...
![img](TCP三次握手与四次挥手面试题.assets/isn不相同.png)
...
![MTU 与 MSS](TCP三次握手与四次挥手面试题.assets/format,png-20230309230633447.png)
...
![握手阶段协商 MSS](TCP三次握手与四次挥手面试题.assets/format,png-20230309230628926.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第1次握手丢失.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第2次握手丢失.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第三次握手丢失.drawio.png)
...
![SYN 攻击](TCP三次握手与四次挥手面试题.assets/format,png-20230309230625853.png)
...
![正常流程](TCP三次握手与四次挥手面试题.assets/format,png-20230309230622886.png)
...
![tcp_syncookies 应对 SYN 攻击](TCP三次握手与四次挥手面试题.assets/format,png-20230309230618804.png)
...
![客户端主动关闭连接 —— TCP 四次挥手](TCP三次握手与四次挥手面试题.assets/format,png-20230309230614791.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第一次挥手丢失.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第二次挥手丢失.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第三次挥手丢失.drawio.png)
...
![img](TCP三次握手与四次挥手面试题.assets/第四次挥手丢失drawio.drawio.png)
...
![TCP 抓包图](TCP三次握手与四次挥手面试题.assets/c9ea9b844e87bcd4acd3e320403ecab3.png)

通过前面我们知道，**序列号和初始化序列号并不是无限递增的，会发生回绕为初始值的情况，这意味着无法根据序列号来判断新老数据**。

假设 TIME-WAIT 没有等待时间或时间过短，被延迟的数据包抵达后会发生什么呢？

![TIME-WAIT 时间过短，收到旧连接的数据报文](TCP三次握手与四次挥手面试题.assets/6385cc99500b01ba2ef288c27523c1e7-20230309230608128.png)
...
![TIME-WAIT 时间过短，没有确保连接正常关闭](TCP三次握手与四次挥手面试题.assets/3a81c23ce57c27cf63fc2b77e34de0ab-20230309230604522.png)

服务端收到这个 RST 并将其解释为一个错误（Connection reset by peer），这对于一个可靠的协议来说不是一个优雅的终止方式。

为了防止这种情况出现，客户端必须等待足够长的时间，确保服务端能够收到 ACK，如果服务端没有收到 ACK，那么就会触发 TCP 重传机制，服务端会重新发送一个 FIN，这样一去一来刚好两个 MSL 的时间。

![TIME-WAIT 时间正常，确保了连接正常关闭](TCP三次握手与四次挥手面试题.assets/TIME-WAIT连接正常关闭.drawio.png)
...
![HTTP 短连接](TCP三次握手与四次挥手面试题.assets/d6f6757c02e3afbf113d1048c937f8ee.png)
...
![img](TCP三次握手与四次挥手面试题.assets/d2b20d1cc03936332adb2a68512eb167.png)
...
![HTTP 长连接超时](TCP三次握手与四次挥手面试题.assets/7e995ecb2e42941342f97256707496c9.png)
...
![img](TCP三次握手与四次挥手面试题.assets/format,png-20230309230552557.png)
...
![web 服务的 心跳机制](TCP三次握手与四次挥手面试题.assets/2d872f947dedd24800a1867dc4f8b9ce.png)
...
![基于 TCP 协议的客户端和服务端工作](TCP三次握手与四次挥手面试题.assets/format,png-20230309230545997.png)
...
![ SYN 队列 与 Accpet 队列 ](TCP三次握手与四次挥手面试题.assets/format,png-20230309230542373.png)
...
![socket 三次握手](TCP三次握手与四次挥手面试题.assets/socket三次握手.drawio.png)
...
![客户端调用 close 过程](TCP三次握手与四次挥手面试题.assets/format,png-20230309230538308.png)
...
![半连接队列与全连接队列](TCP三次握手与四次挥手面试题.assets/3.jpg)
